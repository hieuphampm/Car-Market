...
struct LoginView: View {
    ...
    @State private var isLoggedIn = false  // Kiểm tra đăng nhập thành công
        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 20) {
                    ...
                    // Chuyển hướng sang HomeView sau khi đăng nhập thành công
                    NavigationLink(
    ...
    func login() {
        ...
        Auth.auth().signIn(withEmail: email, password: password) { result, error in
            ...
            if let error = error {
                ...
                isLoggedIn = true  // Chuyển sang HomeView sau khi đăng nhập
            }
        }
    }
